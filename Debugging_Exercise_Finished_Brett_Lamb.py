def calculate_discount(price, discount_rate):
    #calculates the discounted price amount based on its price and the discount rate
    discount_amount = price * discount_rate
    return discount_amount

def apply_discount(price, discount_amount):
    #apply the discount amount to the original price and give us back the new price
...
def main():
    ...
    for product in products:
        try:
            ...
            print(f"Error: The price for {product['name']} is not a valid number.")
            print()
